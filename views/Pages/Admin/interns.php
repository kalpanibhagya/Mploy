...
<div class="row">
    <h4 style="text-align: center;font-weight: bolder">Internship Applicants</h4><br/>

    <br/>
</div>

<div class = "row">
    <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add New Interns</button>
    <br />
    <br />
    <br />
...
<script type="text/javascript">
    ...
    function add_person()
    {
        ...
        $('.modal-title').text('Add New Intern'); // Set Title to Bootstrap modal title
    }
    ...
    function edit_person(applicant_id)
    {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                $('.modal-title').text('Edit Intern'); // Set title to Bootstrap modal title
