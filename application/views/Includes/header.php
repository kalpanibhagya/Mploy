...
<head>
    ...
    <style>
        .page-bg {
            background-image: url('<?php echo base_url(); ?>assets/images/welcomeMploy.png');
            position: fixed;
            width: 100%;
            height: 100%;
            top: 0;
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="color: forestgreen; font-size: 200%; font-weight: bolder" href="<?php echo base_url(); ?>" >M-Ploy</a>
            </div>
