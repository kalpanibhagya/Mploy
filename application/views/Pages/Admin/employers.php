...
<div class = "row">
    ...
    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tr>
            <th>Company Name</th>
            <th>Company Registrtion Number</th>
            <th>Country</th>
            <th>Email</th>
            <th>Address</th>
...
<script type="text/javascript">
    ...
    function add_person()
    {
        ...
        $('.modal-title').text('Add New Company'); // Set Title to Bootstrap modal title
    }
    ...
    function delete_person(id)
    {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url : "<?php echo site_url('Admin_dashboard/ajax_delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
    ...
    {
        $.ajax({
            url : "<?php echo site_url('Admin_dashboard/list_by_id')?>/" + id,
            type: "GET",
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="email" name="address" placeholder="Email" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Hiring Status</label>
                            <div class="col-md-9">
                                <select class="form-control" name= "country" style="height: 50px">
