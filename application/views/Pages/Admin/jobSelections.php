            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php echo base_url(); ?>Admin/selection_jobapplicants"><i class="fa fa-circle-o"></i> Job Applicants Selection</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <ol class="breadcrumb">
                ...
                <li class="active">Job Applicants Selections</li>
            </ol>
        </section><br/>

        <section class="content">
            <h4 style="text-align: center;font-weight: bolder">Job Applicants Selections</h4><br/>
