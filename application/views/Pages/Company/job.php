            ...
            <div id="sectionB" class="tab-pane fade">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form method="post" action="<?php echo base_url() ?>Company/evaluation_validation">
                                                ...
                                                <div class="form-group">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            <td>Masters</td>
                                                            <td>
                                                                <input class="form-control" id="marks4" name="marks4"
                                                                       type="number" required="">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>PhD</td>
                                                            <td>
                                                                <input class="form-control" id="marks5" name="marks5"
                                                                       type="number" required="">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <div class="form-group">
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>Full time</td>
                                                            <td>
                                                                <input class="form-control" id="marks6" name="marks6"
                                                                       type="number" required="">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>Part time</td>
                                                            <td>
                                                                <input class="form-control" id="marks7" name="marks7"
                                                                       type="number" required="">
                                                            </td>
                                                        </tr>
                                                        <tr>
