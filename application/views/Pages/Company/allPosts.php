...
<div class="container" align="center" style="margin-top: 70px">
    ...
    <div class="inline">
        <a class="btn btn-success" href="<?php echo base_url(); ?>Company/post_an_internship"><i class="glyphicon glyphicon-send"></i> Post new Internship</a>         <a class="btn btn-success" href="<?php echo base_url(); ?>Company/post_a_job"><i class="glyphicon glyphicon-send"></i> Post new Job</a>
