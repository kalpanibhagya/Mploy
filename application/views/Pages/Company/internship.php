                                ...
                                <div class="floating-box">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control datepicker" id="from" name="from" required="">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control datepicker" id="selection_date" name="selection_date" placeholder="yyyy-mm-dd" required="">
                                            </div>
                                            <div class="form-group">
