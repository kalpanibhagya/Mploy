            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?php echo base_url(); ?>Company/posted_internships"><i class="fa fa-circle-o"></i> Internships</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="input-group">
                <input type="text" class="search form-control" placeholder="Search posted Internships" width="50px">
